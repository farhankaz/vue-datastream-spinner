<template>
  <svg ref="img" version="1.1" 
    viewBox="0 0 34 34" style="height:25px">
...
export default {
  ...
  mounted() {
    this.tween = TweenMax.to(this.$refs["img"], 1/this.spinsPerSecond, 
      {rotationZ:359, repeat:-1, ease:Linear.easeNone}
    )
  }
}
</script>
